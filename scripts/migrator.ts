...
const IMG_BUCKET = env("IMG_BUCKET", "")
const IMG_FOLDER = renv("IMG_FOLDER", 'images/')
const IMG_ACCESS_HOST = env("IMG_ACCESS_HOST", S3_ENDPOINT)
const FILE_BUCKET = env("FILE_BUCKET", "")
const FILE_FOLDER = renv("FILE_FOLDER", 'files/')
const FILE_ACCESS_HOST = env("FILE_ACCESS_HOST", S3_ENDPOINT)
const CACHE_BUCKET = env("CACHE_BUCKET", "")
const CACHE_FOLDER = renv("CACHE_FOLDER", 'cache/')
const CACHE_ACCESS_HOST = env("CACHE_ACCESS_HOST", S3_ENDPOINT)
...
IMG_ACCESS_HOST = "${IMG_ACCESS_HOST}"
FILE_BUCKET = "${FILE_BUCKET}"
FILE_FOLDER = "${FILE_FOLDER}"
FILE_ACCESS_HOST = "${FILE_ACCESS_HOST}"
CACHE_BUCKET = "${CACHE_BUCKET}"
CACHE_FOLDER = "${CACHE_FOLDER}"
CACHE_ACCESS_HOST = "${CACHE_ACCESS_HOST}"
...
await putSecret('WEATHER_API_KEY', weatherApiKey)
