    ...
    <>
      ...
      <div className="fixed bottom-40 right-4 z-50">
        <button
          ...
          className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm transition-all ${
            musicEnabled 
              ? 'bg-[#b87d4a] text-white hover:bg-[#9e6b3c] active:bg-[#845831]' 
      ...
      <div className="fixed bottom-24 right-4 z-50">
        <button
          ...
          className="w-12 h-12 rounded-full bg-[#b87d4a] text-white flex items-center justify-center shadow-lg hover:bg-[#9e6b3c] active:bg-[#845831] transition-all touch-manipulation"
          aria-label="回到顶部"
        >
